...
RUST_LOG=runtime=trace,pallet_substrate_bridge=trace,runtime::bridge-messages=trace,pallet_bridge_call_dispatch=trace ./bin/rialto-bridge-node-benchmarks benchmark --pallet=pallet_bridge_messages --extrinsic=*
